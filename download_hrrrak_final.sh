...
# export HRRR_VARS="HGT:surface|TMP:2 m|RH:2 m|DPT: 2 m|UGRD:10 m|VGRD:10 m|TCDC:|APCP:surface|DSWRF:surface" # Joe's list 
# export HRRR_VARS="TMP:surface|TMP:2 m|RH:2 m|UGRD:10 m|VGRD:10 m|DSWRF:surface|DLWRF:surface|APCP:surface|PRATE:surface" # minimal list for snowpack 

# export HRRR_VARS="TMP:surface|TMP:2 m|RH:2 m|UGRD:10 m|VGRD:10 m|DSWRF:surface|DLWRF:surface|APCP:surface|PRATE:surface|SNOD:surface|TSOIL:0-0 m|WEASD:surface|SNOWC:surface|ASNOW:surface" # all
export HRRR_VARS="PRES:surface|HGT:surface|TMP:surface|TMP:2 m|RH:2 m|UGRD:10 m|VGRD:10 m|DSWRF:surface|DLWRF:surface|APCP:surface|PRATE:surface|SNOD:surface|TSOIL:0-0|WEASD:surface|SNOWC:surface|ASNOW:surface" # trying tsoil at surface instead
